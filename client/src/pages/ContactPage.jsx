  ...
  return (
    <ContactPageWrapper>
      ...
      <div className="contacts">
        <a
          href="https://www.instagram.com/crochesdaida/"
          rel="noreferrer"
          target="_blank"
        ...
        >
          <div className="card">
            ...
            <div>
              <span
                style={{ margin: 0, fontSize: '1.1rem', fontWeigth: '500' }}
              >
        ...
        <a
          href="mailto:crochesdaida@email.com?subject=Pedido de informações&body=Gostaria%20de%20saber%20mais%20sobre%20seu%20trabalho."
          style={{ textDecoration: 'none', color: 'inherit' }}
        >
          <div className="card">
